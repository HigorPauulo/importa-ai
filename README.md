...
> **Status:** em fase de modelagem para a entrega N2 (22/05/2026) do Projeto Integrador IV — ADS 4º Período — PUC Goiás 2026/1.
...
```
importa-ai/
├── artefatos/                       Documentação acadêmica e arquitetural
│   ├── design-de-software/          ERS, design patterns, diagramas C4, ADRs
│   ├── mensageria-e-streams/        Arquitetura da mensageria
│   ├── modelagem-de-interfaces/     Guia de estilos, wireframes
│   ├── qualidade-de-software/       Plano de testes
│   └── modelagem-de-dados/          DER (em construção)
├── backend/                         API REST + consumidores RabbitMQ (Java)
├── frontend/                        Interface React + TypeScript
└── infra/                           Docker Compose + configs de ambiente
```
...
> **Aviso:** ambiente em construção. Os diretórios `backend/` e `infra/` estão sendo populados para a entrega N2 (22/05/2026). As instruções abaixo refletem o estado-alvo do sistema funcionando.
...
Projeto acadêmico — Projeto Integrador IV — ADS 4º Período — PUC Goiás 2026/1.
