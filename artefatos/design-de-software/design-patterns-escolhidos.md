...
| **Outbox Pattern** | Resolveria a contradição RN03 vs broker indisponível (UC01 FA02), mas adiciona complexidade significativa (tabela outbox, worker dedicado, polling/CDC). Ficou para v2. Atualmente, RN03 cede ao 503 honesto quando o broker está fora. |
