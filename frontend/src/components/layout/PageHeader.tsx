...
export function PageHeader({ titulo, subtitulo, acao }: PageHeaderProps) {
    return (
        <header className="-mx-5 -mt-6 mb-6 flex items-start justify-between gap-3 bg-white px-5 py-4 shadow-[0px_1px_2px_rgba(0,0,0,0.08)] lg:mx-0 lg:mt-0 lg:mb-8 lg:gap-4 lg:bg-transparent lg:px-0 lg:py-0 lg:shadow-none">
